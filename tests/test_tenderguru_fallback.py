...
class TenderGuruFallbackTests(unittest.TestCase):
    ...
    def test_search_resolves_topic_for_declined_query_form(self) -> None:
        with patch("src.collectors.tenderguru_fallback._SESSION.get") as get:
    ...
    def test_rts_filters_to_rts_listings(self) -> None:
        with patch("src.collectors.tenderguru_fallback._SESSION.get") as get:
            get.return_value = Mock(
                raise_for_status=lambda: None,
                text="""
    ...
    def test_eis_keeps_44_and_223_listings(self) -> None:
        with patch("src.collectors.tenderguru_fallback._SESSION.get") as get:
            get.return_value = Mock(
                raise_for_status=lambda: None,
                text="""
