...
_ALLOWED_TRANSITIONS = {
    STATUS_NEW: frozenset({STATUS_REVIEWING, STATUS_PARTICIPATING, STATUS_SKIPPED, STATUS_EXPIRED}),
    ...
    STATUS_LOST: frozenset({STATUS_ARCHIVED}),
    STATUS_SKIPPED: frozenset({STATUS_ARCHIVED}),
